...
const SB_TOOLS = ['Keyword Hunter', 'Domain Overview', 'Organic Research', 'Keyword Gap', 'Position Tracking', 'Site Audit', 'Backlink Analyse'];
  ...
  return (
    <nav className="sidebar" aria-label="Navigation principale">
      ...
      <div className="sidebar-body">
        ...
        {toolsOpen && <div>{SB_TOOLS.map(l => <button key={l} type="button" className="nav-sub-item"><span aria-hidden="true" style={{ width: 4, height: 4, borderRadius: '50%', background: 'var(--fg4)', flexShrink: 0 }}></span>{l}</button>)}</div>}
      </div>
      <div className="sidebar-foot">
