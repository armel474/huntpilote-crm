...
> **L'éditeur de rapport existe déjà** (session 1.3, route
> `/clients/[id]/rapports/[r]`), avec ses six états : brouillon, bloqué par une
> relecture, prêt à publier, publié, corrigé en v2, période sans preuve. Cet
> écran est la **liste** de ces états sur tout le portefeuille — il ne rejoue ni
> la composition, ni la publication, ni le déblocage. Une ligne mène à l'éditeur.
>
> Les libellés d'état doivent être **identiques** à ceux de l'éditeur. Deux
> vocabulaires pour le même état, c'est deux fois la même question posée au
> support.
